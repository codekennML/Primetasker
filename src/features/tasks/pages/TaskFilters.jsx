...
export const allCategories = [
  ...
  { id: 21, name: "Appliances" },
  { id: 22, name: "Grocery" },
  { id: 23, name: "Travel" },
  { id: 24, name: "Art" },
  { id: 25, name: "Crafts" },
  { id: 26, name: "Gardening" },
  { id: 27, name: "Industrial" },
  { id: 28, name: "Science" },
  { id: 29, name: "Antiques" },
  { id: 30, name: "Collectibles" },
  { id: 31, name: "Coins" },
  { id: 32, name: "Stamps" },
  { id: 33, name: "Vintage" },
  { id: 34, name: "Memorabilia" },
  { id: 35, name: "Confectionery" },
  { id: 36, name: "Stationery" },
  { id: 37, name: "Magazines" },
  { id: 38, name: "Comics" },
