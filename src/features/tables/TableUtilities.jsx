...
const TableUtilities = ({
  ...
  return (
    <div>
      ...
      <header className="mt-4 pr-5 py-3  rounded-lg bg-gradient-to-br  from-purple-700/90 to-purple-700/90 border-purple-400  dark:bg-gray-800 pl-4 py-2  flex items-center justify-between dark:border-none">
        <div className="flex flex-1 items-center justify-between  values-center space-x-1.5 w-full mt-1 ">
          <h3 className="font-bold text-white  text-[20px] pr-8 pl-4">
            {tableTitle}
          </h3>
          <div className=" ">
                ...
                <Form className="flex flex-row items-center space-x-4  w-full ">
                  <div className=" relative">
                    <CustomText
                      ...
                      inputstyle={` w-64 bg-transparent outline-none text-[13px] caret-indigo-400 dark:caret-gray-300  dark:bg-gray-700 border-b-2 border-x-0 border-t-0 outline-none  border-gray-100 dark:border-gray-600 text-white dark:text-gray-400 placeholder:text-gray-100 py-1.5 focus:bg-transparent  w-full text-xs `}
                      placeholder={searchTitle}
                      svgclass={`text-[13px] text-gray-200 font-thin dark:text-gray-400 absolute top-[28%] left-[0%]  z-10 `}
                    />
                  </div>
                  ...
                  <div className=" flex values-center  px-2  rounded-md    ">
                    <CustomSelect
                      ...
                      name="filter"
                      // value={filter}
                      selectstyle={`bg-transparent text-white  rounded   text-[13px] hover:bg-purple-500`}
                  ...
                  <div className="relative flex values-center px-2 rounded-md      ">
                    <CustomSelect
                      ...
                      selectstyle={`bg-transparent text-white  rounded  hover:bg-purple-500  text-[13px]`}
                    />
                  </div>
                </Form>
              )}
        ...
        <div className="space-x-3 flex ">
          {
            <CSVLink
              ...
              target="_blank"
            >
              <button className=" mr-4 flex values-center py-2 px-3 ml-2 text-[13px] text-white font-medium text-white   dark:border-gray-600  rounded-lg  hover:bg-purple-500  focus:outline-none  dark:bg-transparent dark:hover:bg-gray-600 dark:text-white">
...

          {
            <button
              ...
              className="mr-4 flex values-center py-2 px-3 ml-2 text-[13px] font-medium  text-white dark:border-gray-600   rounded-lg  hover:bg-purple-500  focus:outline-none  dark:bg-transparent dark:hover:bg-gray-600 dark:text-white"
            >
              <span className="pr-2 text-[10px]">
