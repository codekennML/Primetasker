...
const BookingDateModal = ({ date, setDate, isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      <div
        className={` rounded invisible lg:visible ${
          isOpen
            ? "transition ease-in-out duration-500 opacity-100 "
            : "opacity-0 ease-out duration-500 invisible"
        } absolute   opacity-80  top-16 lg:left-[25%]  justify-center items-center shadow-md rounded-lg`}
      >
