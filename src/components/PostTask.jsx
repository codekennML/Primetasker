...
import { selectDraftTask, setTask } from "../features/tasks/slices/taskSlice";
...
const PostTask = () => {
  ...
  //This will run when the user clicks the previous button thus refreshing the initial values of formik to the existing values in LS

  // useEffect(
  //   (e) => {
  //     e.preventDefault();
  //     setInitialFormData((prev) => {
  //       return { ...prev, ...JSON.parse(localStorage.getItem("draftTask")) };
  //     });
  //   },
  //   [review]
  // );
