...
const Verification = () => {
  return (
    <article className="">
      <div className="flex flex-row justify-between mb-4 text-gray-600 my-4 pb-4 pt-2">
        <div className="w-[300px] pr-3 ">
          ...
          <div>
            ...
            <ul className="list-none text-xs space-y-2 mt-1">
              ...
              <li>
                Letter of Recommendation Details containing Valid ID, Utility
                Bill and Statement of Account (*taskers)
              </li>
            </ul>
          </div>
        </div>
